          ...
          <div className="content-area py-3 px-3">
            ...
            { tabView === LIST_VIEW && itemsWithCategory.length === 0 &&
              <div className="alert alert-light text-center no-record">
                You don't have any accounting records yet
              </div>
            }
            { tabView === CHART_VIEW &&
              <React.Fragment>
                <PieChart title="Monthly outcome" categoryData={chartOutcomDataByCategory} />
                <PieChart title="Monthly income" categoryData={chartIncomeDataByCategory} />
              </React.Fragment>
            }
            </React.Fragment>
          }
